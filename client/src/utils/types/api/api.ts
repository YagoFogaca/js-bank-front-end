...
import { UserContextType } from '../index.context';
...
export class Api {
  ...
  static async verifyEmailCode(data: { emailAddress: string, emailCode: string }) {
  ...
  static async faceRegistration(data: { documentNumber: string, imageBase64: string | undefined }) {
